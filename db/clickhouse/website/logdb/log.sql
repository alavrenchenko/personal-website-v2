...
CREATE TABLE IF NOT EXISTS website_logdb.log

CREATE TABLE IF NOT EXISTS website_logdb.log_queue
SETTINGS
    kafka_broker_list = 'localhost:9092',
    kafka_topic_list = 'website.log',
    kafka_group_name = 'website_log_clickhouse',
    kafka_format = 'ProtobufSingle',
    kafka_schema = 'personalwebsite/logging/log_entry:LogEntry';

CREATE MATERIALIZED VIEW IF NOT EXISTS website_logdb.log_consumer TO website_logdb.log AS
SELECT
    ...
FROM website_logdb.log_queue;
