...
CREATE TABLE IF NOT EXISTS actiondb.transactions
(
    id UUID,
...
CREATE TABLE IF NOT EXISTS actiondb.transaction_queue
(
    id String,
...
SETTINGS
    ...
    kafka_topic_list = 'base.transactions',
    kafka_group_name = 'base_transactions_clickhouse',
    kafka_format = 'ProtobufSingle',
    kafka_schema = 'personalwebsite/actions/transaction:Transaction';

CREATE MATERIALIZED VIEW IF NOT EXISTS actiondb.transaction_consumer TO actiondb.transactions AS
SELECT
    toUUID(id) AS id,
    app,
    app_session_id,
...
FROM actiondb.transaction_queue;
