...
CREATE TABLE IF NOT EXISTS logging_manager_logdb.log

CREATE TABLE IF NOT EXISTS logging_manager_logdb.log_queue
SETTINGS
    kafka_broker_list = 'localhost:9092',
    kafka_topic_list = 'logging_manager.log',
    kafka_group_name = 'logging_manager_log_clickhouse',
    kafka_format = 'ProtobufSingle',
    kafka_schema = 'personalwebsite/logging/log_entry:LogEntry';

CREATE MATERIALIZED VIEW IF NOT EXISTS logging_manager_logdb.log_consumer TO logging_manager_logdb.log AS
SELECT
    ...
FROM logging_manager_logdb.log_queue;
