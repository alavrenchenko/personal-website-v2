...
CREATE TABLE IF NOT EXISTS identity_logdb.log

CREATE TABLE IF NOT EXISTS identity_logdb.log_queue
SETTINGS
    kafka_broker_list = 'localhost:9092',
    kafka_topic_list = 'identity.log',
    kafka_group_name = 'identity_log_clickhouse',
    kafka_format = 'ProtobufSingle',
    kafka_schema = 'personalwebsite/logging/log_entry:LogEntry';

CREATE MATERIALIZED VIEW IF NOT EXISTS identity_logdb.log_consumer TO identity_logdb.log AS
SELECT
    ...
FROM identity_logdb.log_queue;
