...
CREATE TABLE IF NOT EXISTS web_client_logdb.log

CREATE TABLE IF NOT EXISTS web_client_logdb.log_queue
SETTINGS
    kafka_broker_list = 'localhost:9092',
    kafka_topic_list = 'web_client.log',
    kafka_group_name = 'web_client_log_clickhouse',
    kafka_format = 'ProtobufSingle',
    kafka_schema = 'personalwebsite/logging/log_entry:LogEntry';

CREATE MATERIALIZED VIEW IF NOT EXISTS web_client_logdb.log_consumer TO web_client_logdb.log AS
SELECT
    ...
FROM web_client_logdb.log_queue;
