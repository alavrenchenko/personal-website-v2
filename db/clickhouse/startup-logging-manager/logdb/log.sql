...
CREATE TABLE IF NOT EXISTS startup_logging_manager_logdb.log

CREATE TABLE IF NOT EXISTS startup_logging_manager_logdb.log_queue
SETTINGS
    kafka_broker_list = 'localhost:9092',
    kafka_topic_list = 'startup_logging_manager.log',
    kafka_group_name = 'startup_logging_manager_log_clickhouse',
    kafka_format = 'ProtobufSingle',
    kafka_schema = 'personalwebsite/logging/log_entry:LogEntry';

CREATE MATERIALIZED VIEW IF NOT EXISTS startup_logging_manager_logdb.log_consumer TO startup_logging_manager_logdb.log AS
SELECT
    ...
FROM startup_logging_manager_logdb.log_queue;
