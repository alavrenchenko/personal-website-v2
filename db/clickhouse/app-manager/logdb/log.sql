...
CREATE TABLE IF NOT EXISTS app_manager_logdb.log

CREATE TABLE IF NOT EXISTS app_manager_logdb.log_queue
SETTINGS
    kafka_broker_list = 'localhost:9092',
    kafka_topic_list = 'app_manager.log',
    kafka_group_name = 'app_manager_log_clickhouse',
    kafka_format = 'ProtobufSingle',
    kafka_schema = 'personalwebsite/logging/log_entry:LogEntry';

CREATE MATERIALIZED VIEW IF NOT EXISTS app_manager_logdb.log_consumer TO app_manager_logdb.log AS
SELECT
    ...
FROM app_manager_logdb.log_queue;
