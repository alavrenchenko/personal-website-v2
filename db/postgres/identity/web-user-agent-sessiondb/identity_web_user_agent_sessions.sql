...
-- ../db/postgres/common/user-agent-sessiondb/identity_user_agent_sessions.sql

-- Database: identity_web_user_agent_sessions

CREATE DATABASE identity_web_user_agent_sessions
    WITH
    OWNER = postgres
    ENCODING = 'UTF8'
