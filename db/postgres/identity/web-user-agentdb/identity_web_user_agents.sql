...
CREATE DATABASE identity_web_user_agents
    WITH
    OWNER = postgres
    ENCODING = 'UTF8'
...
id:
increment: 1<<8 = 256
start: (1<<8)+1 = 257 // 00000001 00000001(Web), 1(00000001): Web User Agent
min_value: (1<<8)+1 = 257
max_value: (1<<63)-1 = 9223372036854775807 // ((256^8)/2)-1
max_count: (1<<55)-1 = 36028797018963967   // ((256^7)/2)-1, 9223372036854775807>>8
exact_max_value: (36028797018963967*256)+1 = 9223372036854775553 // ((9223372036854775807>>8)<<8)+1, 1: Web User Agent
...
id:
increment: 1<<8 = 256
start: (1<<8)+1 = 257 // 00000001 00000001(Web), 1(00000001): Web User Agent Session
min_value: (1<<8)+1 = 257
max_value: (1<<63)-1 = 9223372036854775807 // ((256^8)/2)-1
max_count: (1<<55)-1 = 36028797018963967   // ((256^7)/2)-1, 9223372036854775807>>8
exact_max_value: (36028797018963967*256)+1 = 9223372036854775553 // ((9223372036854775807>>8)<<8)+1, 1: Web User Agent Session
