...
(
    ...
    mail_account_email character varying(512) COLLATE pg_catalog."default" NOT NULL,
...
CREATE INDEX IF NOT EXISTS notification_groups_mail_account_email_lc_idx ON public.notification_groups (lower(mail_account_email));
