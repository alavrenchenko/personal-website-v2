...
type Application struct {
	...
	configPath        string
	config            *config.AppConfig[*iappconfig.Apis, struct{}]
	...
	postgresManager *postgres.DbManager[ipostgres.Stores]
...
func (a *Application) loadConfig() error {
	...
	config := new(config.AppConfig[*iappconfig.Apis, struct{}])
...
func (a *Application) configureDb() error {
	...
	a.postgresManager = postgres.NewDbManager(ipostgres.NewStores(a.loggerFactory), dbSettings)
	return nil
}
