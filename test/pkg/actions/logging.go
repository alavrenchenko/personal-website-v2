...
func createActionLoggerConfig() *alogging.LoggerConfig {
	return &alogging.LoggerConfig{
		...
		ErrorHandler: onActionLoggingError,
	}
}
...
func onActionLoggingError(entry any, err error) {
	fmt.Println("onActionLoggingError:")
	fmt.Println("[main.onActionLoggingError] entry:", entry)
	fmt.Println("[main.onActionLoggingError] err:", err)
}
