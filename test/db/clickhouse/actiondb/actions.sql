...
-- ../db/clickhouse/actiondb/actions.sql

CREATE TABLE IF NOT EXISTS test_actiondb.actions
(
    id UUID,
...
CREATE TABLE IF NOT EXISTS test_actiondb.action_queue
(
    id String,
...
SETTINGS
    ...
    kafka_topic_list = 'testing.base.actions',
    kafka_group_name = 'test_base_actions_clickhouse',
    kafka_format = 'ProtobufSingle',
    kafka_schema = 'personalwebsite/actions/action:Action';

CREATE MATERIALIZED VIEW IF NOT EXISTS test_actiondb.action_consumer TO test_actiondb.actions AS
SELECT
    toUUID(id) AS id,
    app,
    app_session_id,
...
FROM test_actiondb.action_queue;
