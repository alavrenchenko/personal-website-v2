...
-- ../db/clickhouse/actiondb/operations.sql

CREATE TABLE IF NOT EXISTS test_actiondb.operations
(
    id UUID,
...
CREATE TABLE IF NOT EXISTS test_actiondb.operation_queue
(
    id String,
...
SETTINGS
    ...
    kafka_topic_list = 'testing.base.operations',
    kafka_group_name = 'test_base_operations_clickhouse',
    kafka_format = 'ProtobufSingle',
    kafka_schema = 'personalwebsite/actions/operation:Operation';

CREATE MATERIALIZED VIEW IF NOT EXISTS test_actiondb.operation_consumer TO test_actiondb.operations AS
SELECT
    toUUID(id) AS id,
    app,
    app_session_id,
...
FROM test_actiondb.operation_queue;
