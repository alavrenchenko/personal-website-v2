...
CREATE TABLE IF NOT EXISTS test_logdb.log

CREATE TABLE IF NOT EXISTS test_logdb.log_queue
SETTINGS
    kafka_broker_list = 'localhost:9092',
    kafka_topic_list = 'testing.log',
    kafka_group_name = 'test_log_clickhouse',
    kafka_format = 'ProtobufSingle',
    kafka_schema = 'personalwebsite/logging/log_entry:LogEntry';

CREATE MATERIALIZED VIEW IF NOT EXISTS test_logdb.log_consumer TO test_logdb.log AS
SELECT
    ...
FROM test_logdb.log_queue;
